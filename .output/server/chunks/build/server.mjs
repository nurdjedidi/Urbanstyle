import { version as version$1, unref, inject as inject$1, watch, onScopeDispose, reactive, computed, watchEffect, toRefs, capitalize, shallowRef, warn, getCurrentInstance as getCurrentInstance$1, ref, provide, defineComponent as defineComponent$1, toRaw, createVNode, mergeProps, shallowReactive, h, Suspense, nextTick, Fragment, Transition, isRef, toRef, Text, hasInjectionContext, effectScope, resolveComponent, useSSRContext, createApp, getCurrentScope, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, defineAsyncComponent, isReadonly, isShallow, isReactive, withCtx } from 'vue';
import { $ as $fetch, k as defu, p as parseQuery, l as getContext, m as createHooks, e as createError$1, n as hasProtocol, o as joinURL, q as isScriptProtocol, w as withQuery, r as sanitizeStatusCode, v as withTrailingSlash, x as withoutTrailingSlash, y as toRouteMatcher, z as createRouter$1 } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-3gJyuOYr.mjs')
  },
  {
    name: "panier",
    path: "/panier",
    component: () => import('./panier-BXaEDJ0y.mjs')
  }
];
...
const cart_KnoRTcAkJx = /* @__PURE__ */ defineNuxtPlugin(() => {
  const cart = reactive([]);
...
const _imports_0 = "" + __buildAssetsURL("urban.C-XTqZ9i.png");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<!--[--><header><img class="urban"${ssrRenderAttr("src", _imports_0)} alt="Urbanstyle"><section class="intro d-flex ga-5">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(VIcon, { icon: "mdi-home-outline" }, null, _parent2, _scopeId));
      } else {
        return [
          createVNode(VIcon, { icon: "mdi-home-outline" })
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(ssrRenderComponent(VIcon, { icon: "mdi-account-outline" }, null, _parent));
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/panier",
    id: "cart-link"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(VIcon, { icon: "mdi-cart-outline" }, null, _parent2, _scopeId));
      } else {
        return [
          createVNode(VIcon, { icon: "mdi-cart-outline" })
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`</section></header><h1>Saison Hivernale</h1><h2>Recommander pour vous</h2><article class="link-container"><a href="#">Homme</a><a href="#">Femme</a><a href="#">Enfant</a><a href="#">Saisons</a><a href="#">Collections</a></article><!--]-->`);
}
...
export { getCurrentInstance as A, templateRef as B, matchesSelector as C, useToggleScope as D, EventProp as E, useBackgroundColor as F, useNuxtApp as G, includes as H, IconValue as I, getCurrentInstanceName as J, useColor as K, getUid as L, wrapInArray as M, findChildrenWithProvide as N, consoleWarn as O, useTextColor as P, hasEvent as Q, isObject as R, keyCodes as S, VIcon as V, _export_sfc as _, __nuxt_component_0 as a, makeDisplayProps as b, makeTagProps as c, useDisplay as d, entry$1 as default, useGoTo as e, useRender as f, genericComponent as g, focusableChildren as h, injectHead as i, deepEqual as j, makeThemeProps as k, provideTheme as l, makeComponentProps as m, provideDefaults as n, makeSizeProps as o, propsFactory as p, useLocale as q, resolveUnrefHeadInput as r, useSize as s, useProxiedModel as t, useRtl as u, destructComputed as v, consoleError as w, convertToUnit as x, clamp as y, defer as z };
